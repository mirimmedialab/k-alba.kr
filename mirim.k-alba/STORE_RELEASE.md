...
### 준비 (1회)
- [ ] Google Play Console 개발자 계정 생성 — https://play.google.com/console ($25 1회, 사업자 계정 권장 · D-U-N-S 불필요, 사업자등록증으로 조직 인증)
...
- 2단계(앱스토어)는 Sign in with Apple 구현 + iOS 프로젝트 추가 후 진행 (별도 문서 예정)
