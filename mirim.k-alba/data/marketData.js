...
// ── 업종별 취업 가능 비자 자동 안내 (2026-07 기준 출입국·고용부 규정 요약) ──
//  · 유학생(D-2/D-4): 시간제취업 허가 필요. 서비스업(카페·식당·편의점·호텔·통번역) 가능,
//    제조·건설은 금지(적발 시 출국명령), 개인과외 금지. D-4는 입국 6개월 경과 필요.
//  · E-9(비전문취업): 제조·농축산·어업·건설 등 지정 업종만. 음식점업은 허용지역·직종(주방보조) 한정.
//  · F-4(재외동포): 단순노무 제한(2026 개정으로 일부 완화 — 건설단순종사원·매장정리원 등 허용).
//  · F-2/F-5/F-6: 취업 제한 없음. H-2(방문취업): 대부분 업종 가능. H-1(워홀): 유흥 등 제외 서비스 가능.
//  · D-10(구직): 원칙적 취업 불가. E-7: 허가받은 직종에 한함.
export const VISA_BY_INDUSTRY = {
  "카페":     { ok: ["D-2 유학*", "D-4 어학연수*", "F-2 거주", "F-4 재외동포", "F-5 영주", "F-6 결혼이민", "H-1 워킹홀리데이", "H-2 방문취업"], cond: ["E-7 (허가 직종 한정)"], no: ["E-9 비전문취업", "D-10 구직", "B-1/B-2 관광"] },
  "식당":     { ok: ["D-2 유학*", "D-4 어학연수*", "F-2 거주", "F-4 재외동포", "F-5 영주", "F-6 결혼이민", "H-1 워킹홀리데이", "H-2 방문취업"], cond: ["E-9 (음식점업 허용지역·주방보조 한정)", "E-7 (허가 직종 한정)"], no: ["D-10 구직", "B-1/B-2 관광"] },
  "편의점":   { ok: ["D-2 유학*", "D-4 어학연수*", "F-2 거주", "F-4 재외동포", "F-5 영주", "F-6 결혼이민", "H-1 워킹홀리데이", "H-2 방문취업"], cond: [], no: ["E-9 비전문취업", "D-10 구직", "B-1/B-2 관광"] },
  "제조/생산": { ok: ["E-9 비전문취업", "F-2 거주", "F-5 영주", "F-6 결혼이민", "H-2 방문취업"], cond: ["F-4 (단순노무 직종 확인)", "E-7 (허가 직종 한정)"], no: ["D-2 유학 (금지 — 적발 시 출국명령)", "D-4 어학연수 (금지)", "D-10 구직"] },
  "학원/과외": { ok: ["F-2 거주", "F-5 영주", "F-6 결혼이민"], cond: ["E-7 (강사 자격 필요)", "F-4 (직종 확인)"], no: ["D-2 유학 (개인과외 금지)", "D-4 어학연수 (금지)", "E-9 비전문취업", "D-10 구직"] },
  "번역/통역": { ok: ["D-2 유학*", "F-2 거주", "F-4 재외동포", "F-5 영주", "F-6 결혼이민", "H-1 워킹홀리데이", "H-2 방문취업"], cond: ["E-7 (허가 직종 한정)"], no: ["E-9 비전문취업", "D-10 구직"] },
  "호텔/서비스": { ok: ["D-2 유학*", "D-4 어학연수*", "F-2 거주", "F-4 재외동포", "F-5 영주", "F-6 결혼이민", "H-1 워킹홀리데이", "H-2 방문취업"], cond: ["E-9 (호텔·콘도 청소 등 시범 허용 직종 한정)", "E-7 (허가 직종 한정)"], no: ["D-10 구직", "B-1/B-2 관광"] },
  "농업":     { ok: ["E-9 비전문취업", "F-2 거주", "F-5 영주", "F-6 결혼이민", "H-2 방문취업"], cond: ["F-4 (단순노무 직종 확인)", "E-8 (계절근로)"], no: ["D-2 유학 (시간제취업 허용분야 아님)", "D-4 어학연수", "D-10 구직"] },
  "어업":     { ok: ["E-9 비전문취업", "F-2 거주", "F-5 영주", "F-6 결혼이민", "H-2 방문취업"], cond: ["F-4 (단순노무 직종 확인)", "E-8 (계절근로)"], no: ["D-2 유학 (시간제취업 허용분야 아님)", "D-4 어학연수", "D-10 구직"] },
  "건설":     { ok: ["E-9 비전문취업", "F-2 거주", "F-5 영주", "F-6 결혼이민", "H-2 방문취업"], cond: ["F-4 (2026 개정 — 건설단순종사원 허용)"], no: ["D-2 유학 (금지 — 적발 시 출국명령)", "D-4 어학연수 (금지)", "H-1 워킹홀리데이", "D-10 구직"] },
};
export const VISA_GUIDE_FOOT = "* 유학생(D-2/D-4)은 출입국 '시간제취업 허가'를 받은 경우에만 가능 (D-4는 입국 6개월 경과). 개별 사례는 관할 출입국·외국인청 확인을 권장합니다.";
export function getVisaGuide(jobType) { return VISA_BY_INDUSTRY[jobType] || null; }
